...
def index():
    ...
    pregnancies = Pitch.query.filter_by(category = 'Teenage pregnancies').all()
    return render_template('index.html', lines = lines,jobs = jobs, pitches = pitches,pregnancies= pregnancies)
